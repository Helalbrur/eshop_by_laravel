                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="{{route('card')}}"><i class="fa fa-shopping-cart"></i> Cart</a></li>
                                @if(Session::get('customer_login')==true)
                                    <li><a href="{{route('customer_logout')}}"><i class="fa fa-lock"></i> Logout</a></li>
                                @else
                                    <li><a href="{{route('login_register')}}"><i class="fa fa-lock"></i> Login</a></li>
                                @endif
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-sm-12">
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                         ...
                         <?php $sliders=DB::table('sliders')->get(); $slc=0;?>
                            @foreach($sliders as $slider)

                            <div class="item <?php if(++$slc==1){echo "active";}?>">
                                <div class="col-sm-6">
                                    <h1>{{$slider->title}}</h1>
                                    <h2>{{$slider->slogan}}</h2>
                                    <p>{{$slider->body}} </p>
                                ...
                                <div class="col-sm-6">
                                    <img src="{{URL::to('uploads/'.$slider->image)}}" class="girl img-responsive" alt="" />
                                    <img src="{{URL::to('uploads/'.$slider->price_image)}}"  class="pricing" alt="" />
                                </div>
                ...
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        ...
                        <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="{{route('products_by_category',$cat->category_id)}}">{{$cat->category_name}}</a></h4>
                                </div>
                            </div>
                            @endforeach
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    @foreach($brands as $brnd)
                                        ...
                                        <?php $products=DB::table('products')->where('brand_id',$brnd->id )->count()?>
                                        <li><a href=""> <span class="pull-right">({{$products}})</span>{{$brnd->brand_name}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div><!--/brands_products-->
                        ...
                        <div class="shipping text-center"><!--shipping-->
                            <img src="{{URL::to('forntend/images/home/shipping.jpg')}}" alt="" />
                        </div><!--/shipping-->
                    ...
                    <div class="col-sm-7">
                            ...
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{URL::to('forntend/images/home/iframe1.png')}}" alt="" />
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{URL::to('forntend/images/home/iframe2.png')}}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{URL::to('forntend/images/home/iframe3.png')}}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="video-gallery text-center">
                                <a href="#">
                                    <div class="iframe-img">
                                        <img src="{{URL::to('forntend/images/home/iframe4.png')}}" alt="" />
                                    </div>
                                    <div class="overlay-icon">
                                        <i class="fa fa-play-circle-o"></i>
                                    </div>
