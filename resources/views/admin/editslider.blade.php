                        ...
                        <div class="card-body">
		                  	<form method="post" action="{{route('updateslider',$slider->id)}}" enctype="multipart/form-data">
							    ...
							    <div class="form-group ml-4 mr-4">
							      ...
							      <textarea type="text" class="form-control" id="body" name="body" rows="3">{{$slider->body}}</textarea>
							    </div>
							    
							   	 <div class="form-group ml-4 mr-4">
							      <img src="{{URL::to('uploads/'.$slider->image)}}" width="200px" height="200px">
							    </div>
							    <div class="form-group ml-4 mr-4">
							     ...
							     <div class="form-group ml-4 mr-4">
							      <img src="{{URL::to('uploads/'.$slider->price_image)}}" width="200px" height="200px">
							    </div>
							    <div class="form-group ml-4 mr-4">
